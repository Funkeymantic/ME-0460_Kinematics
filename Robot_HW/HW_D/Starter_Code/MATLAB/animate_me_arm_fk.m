function animate_me_arm_fk(TH, label, record_video, filename)
...
for n = 1:n_frames
    ...
    % Apply FK: transform patch vertices into world frame 
    % testing motor based FK...
    PV0 = me_arm_gs0_mot(th) * HV0;
    PV1 = me_arm_gs1_mot(th) * HV1;
    PV2 = me_arm_gs2_mot(th) * HV2;
    PV3 = me_arm_gst_mot(th) * HV3;
