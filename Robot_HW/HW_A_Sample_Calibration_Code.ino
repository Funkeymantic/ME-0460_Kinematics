...
const int MIN_PULSE = 525;      // Minimum pulse width in microseconds (you should adjust this)
const int MAX_PULSE = 2400;     // Maximum pulse width in microseconds (you should adjust this)
const int START_POSITION = 1500 ; // Starting position (approximately center) (You should adjust this for each servo)
...
const float SLOPE = 0.0944;      // Replace with your fitted slope (deg/μs)
const float INTERCEPT = -133.7;  // Replace with your fitted intercept (deg)
