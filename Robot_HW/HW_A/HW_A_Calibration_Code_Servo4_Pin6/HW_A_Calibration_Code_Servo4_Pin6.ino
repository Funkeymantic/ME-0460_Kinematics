...
// ===== SERVO CONFIGURATION =====
Servo servo_2;
const int SERVO_PIN = 6;        // PWM pin for servo (can use 3, 9, 10, or 11)
const int MIN_PULSE = 0;      // Minimum pulse width in microseconds (you should adjust this)
const int MAX_PULSE = 2173;     // Maximum pulse width in microseconds (you should adjust this)
const int START_POSITION = 1133; // Starting position (approximately center) (You should adjust this for each servo)
