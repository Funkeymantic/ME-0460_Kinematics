...
// ===== SERVO CONFIGURATION =====
Servo servo_2;
const int SERVO_PIN = 9;        // PWM pin for servo (can use 3, 9, 10, or 11)
const int MIN_PULSE = 473;      // Minimum pulse width in microseconds (you should adjust this)
const int MAX_PULSE = 2473;     // Maximum pulse width in microseconds (you should adjust this)
const int START_POSITION = 1473; // Starting position (approximately center) (You should adjust this for each servo)
...
void setup() {
  ...
  servo_2.attach(SERVO_PIN, MIN_PULSE, MAX_PULSE);
  
  // Move to starting position
  servo_2.writeMicroseconds(current_position_us);
